    ...
    <main className="min-h-screen bg-zinc-950 text-white relative pt-20">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="mb-20 text-center">
          <h1 className="text-4xl md:text-5xl font-light tracking-[0.3em] uppercase mb-6 text-white/90">Vista de Pájaro</h1>
          ...
          <p className="text-white/70 tracking-widest font-light max-w-2xl mx-auto uppercase text-sm">
            El mundo desde otra perspectiva mediante fotografía aérea y drones.
          </p>
        </div>
